...
namespace WebDriverFramework
{
    ...
    //    public IList<WebElement> FindAll(string xpath = ".//*") => FindAll(By.XPath(xpath));
    //    public IList<WebElement> FindAll(By locator) => GetAll(locator).Locate().ToList();

    //    public WebElement Get(string xpath) => Get(By.XPath(xpath));
    //    public WebElement Get(By locator) => new WebElement(locator, this);
    //    public IEnumerable<WebElement> GetAll(string xpath = ".//*") => GetAll(By.XPath(xpath));
    //    public IEnumerable<WebElement> GetAll(By locator) => this.Element.FindElements(locator).Select(e => new WebElement(e, this.WrappedDriver));
    ...
    //    public ReadOnlyCollection<IWebElement> FindElements(By by) => this.FindAll(by).Cast<IWebElement>().ToList().AsReadOnly();
    //    #endregion
    ...
    //        return this.WrappedDriver.Wait<T>(d => condition(this), timeout, exceptionTypes);
    //    }
